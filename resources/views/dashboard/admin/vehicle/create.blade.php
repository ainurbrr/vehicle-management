...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create Vehicle</h1>
    </div>
    <div class="col-lg-8">
        <form action="/vehicles" method="post" class="mb-5">
            @csrf
            <input type="hidden" id="vehicleId">
            <div class="mb-3">
                <label for="license_plate" class="form-label">License Plate</label>
                <input type="text" class="form-control @error('license_plate') is-invalid @enderror" id="license_plate"
                    name="license_plate" required autofocus value="{{ old('license_plate') }}">
                @error('license_plate')
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('fuel_consumption') is-invalid @enderror"
                    id="fuel_consumption" name="fuel_consumption" required autofocus value="{{ old('fuel_consumption') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('pool') is-invalid @enderror" id="pool"
                    name="pool" required autofocus value="{{ old('pool') }}">
                @error('pool')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('service_schedule') is-invalid @enderror"
                    id="service_schedule" name="service_schedule" required autofocus value="{{ old('service_schedule') }}">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('last_service_date') is-invalid @enderror"
                    id="last_service_date" name="last_service_date" autofocus value="{{ old('last_service_date') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('rental_company') is-invalid @enderror" id="rental_company"
                    name="rental_company" autofocus value="{{ old('rental_company') }}">
